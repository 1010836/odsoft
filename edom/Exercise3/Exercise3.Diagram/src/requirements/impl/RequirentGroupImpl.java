 ...
 *   <li>{@link requirements.impl.RequirentGroupImpl#getChildren <em>Children</em>}</li>
...
public class RequirentGroupImpl extends MinimalEObjectImpl.Container implements RequirentGroup {
	 ...
	 * @ordered
	 */
	protected EList<RequirentGroup> children;
	 ...
	 * @generated
	 */
	public EList<RequirentGroup> getChildren() {
		if (children == null) {
			children = new EObjectContainmentWithInverseEList<RequirentGroup>(RequirentGroup.class, this, RequirementsPackage.REQUIRENT_GROUP__CHILDREN, RequirementsPackage.REQUIRENT_GROUP__PARENT);
		}
		return children;
	}
	...
	public RequirentGroup getParent() {
		if (eContainerFeatureID() != RequirementsPackage.REQUIRENT_GROUP__PARENT) return null;
		return (RequirentGroup)eInternalContainer();
	}
	...
	public NotificationChain basicSetParent(RequirentGroup newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, RequirementsPackage.REQUIRENT_GROUP__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(RequirentGroup newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != RequirementsPackage.REQUIRENT_GROUP__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, RequirementsPackage.REQUIRENT_GROUP__CHILDREN, RequirentGroup.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RequirementsPackage.REQUIRENT_GROUP__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetParent((RequirentGroup)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case RequirementsPackage.REQUIRENT_GROUP__PARENT:
				return eInternalContainer().eInverseRemove(this, RequirementsPackage.REQUIRENT_GROUP__CHILDREN, RequirentGroup.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RequirementsPackage.REQUIRENT_GROUP__CHILDREN:
				getChildren().clear();
				getChildren().addAll((Collection<? extends RequirentGroup>)newValue);
				return;
			case RequirementsPackage.REQUIRENT_GROUP__PARENT:
