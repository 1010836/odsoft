...
public class RequirementsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RequirementsPackage.REQUIRENT_GROUP: {
				RequirentGroup requirentGroup = (RequirentGroup)theEObject;
				T result = caseRequirentGroup(requirentGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case RequirementsPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementsPackage.TEAM: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Requirent Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Requirent Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRequirentGroup(RequirentGroup object) {
		return null;
	}
