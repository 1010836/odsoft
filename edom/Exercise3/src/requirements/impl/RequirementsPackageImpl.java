...
public class RequirementsPackageImpl extends EPackageImpl implements RequirementsPackage {
	 ...
	 * @generated
	 */
	private EClass requirentGroupEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getRequirentGroup_Name() {
		return (EAttribute)requirentGroupEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getRequirentGroup_Description() {
		return (EAttribute)requirentGroupEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getRequirentGroup_Id() {
		return (EAttribute)requirentGroupEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getRequirentGroup_Requirements() {
		return (EReference)requirentGroupEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getRequirentGroup_Children() {
		return (EReference)requirentGroupEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getRequirentGroup_Parent() {
		return (EReference)requirentGroupEClass.getEStructuralFeatures().get(5);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(requirentGroupEClass, REQUIRENT_GROUP__DESCRIPTION);
		createEAttribute(requirentGroupEClass, REQUIRENT_GROUP__ID);
		createEReference(requirentGroupEClass, REQUIRENT_GROUP__REQUIREMENTS);
		createEReference(requirentGroupEClass, REQUIRENT_GROUP__CHILDREN);
		createEReference(requirentGroupEClass, REQUIRENT_GROUP__PARENT);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRequirentGroup_Description(), ecorePackage.getEString(), "description", null, 0, 1, RequirentGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequirentGroup_Id(), ecorePackage.getEString(), "id", null, 0, 1, RequirentGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRequirentGroup_Requirements(), this.getRequirement(), null, "requirements", null, 0, -1, RequirentGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRequirentGroup_Children(), this.getRequirentGroup(), this.getRequirentGroup_Parent(), "children", null, 0, -1, RequirentGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRequirentGroup_Parent(), this.getRequirentGroup(), this.getRequirentGroup_Children(), "parent", null, 0, 1, RequirentGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
