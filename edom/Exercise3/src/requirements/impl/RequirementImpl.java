...
public class RequirementImpl extends MinimalEObjectImpl.Container implements Requirement {
	 ...
	 * @ordered
	 */
	protected EList<Requirement> parent;
	 ...
	 * @generated
	 */
	public EList<Requirement> getParent() {
		if (parent == null) {
			parent = new EObjectContainmentEList<Requirement>(Requirement.class, this, RequirementsPackage.REQUIREMENT__PARENT);
		}
		return parent;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RequirementsPackage.REQUIREMENT__PARENT:
				getParent().clear();
				getParent().addAll((Collection<? extends Requirement>)newValue);
				return;
		}
