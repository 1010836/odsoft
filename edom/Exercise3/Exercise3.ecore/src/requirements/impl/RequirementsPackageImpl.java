...
public class RequirementsPackageImpl extends EPackageImpl implements RequirementsPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getRequirentGroup_Parent(), this.getRequirentGroup(), null, "parent", null, 0, 1, RequirentGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRequirement_Parent(), this.getRequirement(), null, "parent", null, 0, -1, Requirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
