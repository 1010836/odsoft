...
public class RequirementsFactoryImpl extends EFactoryImpl implements RequirementsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case RequirementsPackage.REQUIRENT_GROUP: return createRequirentGroup();
	 ...
	 * @generated
	 */
	public RequirentGroup createRequirentGroup() {
		RequirentGroupImpl requirentGroup = new RequirentGroupImpl();
		return requirentGroup;
	}
