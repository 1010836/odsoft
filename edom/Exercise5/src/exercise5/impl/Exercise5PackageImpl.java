 ...
 * @generated
 */
public class Exercise5PackageImpl extends EPackageImpl implements Exercise5Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see exercise5.Exercise5Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Exercise5PackageImpl() {
		super(eNS_URI, Exercise5Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Exercise5Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Exercise5Package init() {
		if (isInited) return (Exercise5Package)EPackage.Registry.INSTANCE.getEPackage(Exercise5Package.eNS_URI);

		// Obtain or create and register package
		Exercise5PackageImpl theExercise5Package = (Exercise5PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Exercise5PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Exercise5PackageImpl());

		isInited = true;

		// Create package meta-data objects
		theExercise5Package.createPackageContents();

		// Initialize created meta-data
		theExercise5Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theExercise5Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Exercise5Package.eNS_URI, theExercise5Package);
		return theExercise5Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getStructuralFeature_Requiered() {
	 ...
	 * @generated
	 */
	public EReference getAtribute_Datatype() {
		return (EReference)atributeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public Exercise5Factory getExercise5Factory() {
		return (Exercise5Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(structuralFeatureEClass, STRUCTURAL_FEATURE__REQUIERED);
		...
		createEReference(atributeEClass, ATRIBUTE__DATATYPE);
		...
		createEAttribute(dataTypeEClass, DATA_TYPE__DEFAULT_LITERAL);
	...
	public void initializePackageContents() {
		...
		atributeEClass.getESuperTypes().add(this.getStructuralFeature());
		...
		initEAttribute(getStructuralFeature_Requiered(), ecorePackage.getEBoolean(), "requiered", "false", 0, 1, StructuralFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTypedElement_Visibility(), this.getVisibility(), "visibility", "PRIVATE", 0, 1, TypedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(packageEClass, exercise5.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_Contents(), this.getPackageableElement(), this.getPackageableElement_Package(), "contents", null, 0, -1, exercise5.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAtribute_Datatype(), this.getDataType(), null, "datatype", null, 0, 1, Atribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getReference_Bidirectional(), ecorePackage.getEBoolean(), "bidirectional", "false", 0, 1, Reference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(classEClass, exercise5.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Abstract(), ecorePackage.getEBoolean(), "abstract", "false", 0, 1, exercise5.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_Interface(), ecorePackage.getEBoolean(), "interface", "false", 0, 1, exercise5.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Operations(), this.getOperation(), this.getOperation_Owner(), "operations", null, 0, -1, exercise5.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Features(), this.getStructuralFeature(), this.getStructuralFeature_Owner(), "features", null, 0, -1, exercise5.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Subclasses(), this.getClass_(), this.getClass_Superclasses(), "subclasses", null, 0, -1, exercise5.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Superclasses(), this.getClass_(), this.getClass_Subclasses(), "superclasses", null, 0, -1, exercise5.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
