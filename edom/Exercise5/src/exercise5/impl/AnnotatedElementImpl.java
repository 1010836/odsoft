 ...
 * </p>
 * <ul>
 *   <li>{@link exercise5.impl.AnnotatedElementImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotatedElementImpl extends MinimalEObjectImpl.Container implements AnnotatedElement {
	...
	protected EClass eStaticClass() {
		return Exercise5Package.Literals.ANNOTATED_ELEMENT;
	}
	...
	public EList<Annotation> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, Exercise5Package.ANNOTATED_ELEMENT__ANNOTATIONS);
		}
		return annotations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Exercise5Package.ANNOTATED_ELEMENT__ANNOTATIONS:
