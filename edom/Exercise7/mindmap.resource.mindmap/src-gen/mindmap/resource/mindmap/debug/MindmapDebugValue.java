...
public class MindmapDebugValue extends mindmap.resource.mindmap.debug.MindmapDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public MindmapDebugValue(mindmap.resource.mindmap.debug.MindmapDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
