...
public class MindmapLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "mindmap.resource.mindmap.debug.lineBreakpoint.marker";
	
	public MindmapLineBreakpoint() {
		super();
	}
	
	public MindmapLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(mindmap.resource.mindmap.debug.MindmapDebugTarget target) {
		try {
	...
	public void remove(mindmap.resource.mindmap.debug.MindmapDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
