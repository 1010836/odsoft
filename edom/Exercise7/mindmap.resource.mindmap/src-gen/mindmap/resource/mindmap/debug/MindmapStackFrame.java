...
public class MindmapStackFrame extends mindmap.resource.mindmap.debug.MindmapDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private mindmap.resource.mindmap.debug.MindmapDebugTarget target;
	private String name;
	private int id;
	...
	public MindmapStackFrame(mindmap.resource.mindmap.debug.MindmapDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = mindmap.resource.mindmap.util.MindmapStringUtil.decode(data, ',');
	...
	private mindmap.resource.mindmap.debug.MindmapDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		mindmap.resource.mindmap.debug.MindmapStackFrame other = (mindmap.resource.mindmap.debug.MindmapStackFrame) obj;
		if (name == null) {
