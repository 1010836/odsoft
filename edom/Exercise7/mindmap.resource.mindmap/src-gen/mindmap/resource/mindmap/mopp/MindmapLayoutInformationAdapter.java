...
/**
 * A MindmapLayoutInformationAdapter is used to store layout information that is
 ...
 * MindmapLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 */
public class MindmapLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<mindmap.resource.mindmap.mopp.MindmapLayoutInformation> layoutInformations = new java.util.ArrayList<mindmap.resource.mindmap.mopp.MindmapLayoutInformation>();
	...
	public java.util.List<mindmap.resource.mindmap.mopp.MindmapLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(mindmap.resource.mindmap.mopp.MindmapLayoutInformation layoutInformation) {
