...
public class MindmapNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "mindmap.resource.mindmap.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {mindmap.resource.mindmap.mopp.MindmapBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(mindmap.resource.mindmap.mopp.MindmapBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
