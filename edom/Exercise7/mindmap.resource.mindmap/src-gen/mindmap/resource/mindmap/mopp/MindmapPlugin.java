 ...
 */
public class MindmapPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "mindmap.resource.mindmap";
	/**
	...
	private static MindmapPlugin plugin;
	...
	public static MindmapPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, MindmapPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, MindmapPlugin.PLUGIN_ID, message);
		}
		final MindmapPlugin pluginInstance = MindmapPlugin.getDefault();
