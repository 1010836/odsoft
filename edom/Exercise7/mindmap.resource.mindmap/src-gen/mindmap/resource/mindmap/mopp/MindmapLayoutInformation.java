...
/**
 * MindmapLayoutInformation objects are used to store layout information that is
 ...
 * MindmapLayoutInformations are aggregated in LayoutInformationAdapters. One
 * MindmapLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class MindmapLayoutInformation {
	 ...
	 */
	private final mindmap.resource.mindmap.grammar.MindmapSyntaxElement syntaxElement;
	...
	public MindmapLayoutInformation(mindmap.resource.mindmap.grammar.MindmapSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public mindmap.resource.mindmap.grammar.MindmapSyntaxElement getSyntaxElement() {
