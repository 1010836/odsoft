...
public class MindmapBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "mindmap.resource.mindmap.builder";
	
	private mindmap.resource.mindmap.IMindmapBuilder defaultBuilder = new mindmap.resource.mindmap.mopp.MindmapBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		mindmap.resource.mindmap.IMindmapBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			mindmap.resource.mindmap.mopp.MindmapResource customResource = (mindmap.resource.mindmap.mopp.MindmapResource) resourceSet.getResource(uri, true);
			new mindmap.resource.mindmap.mopp.MindmapMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public mindmap.resource.mindmap.IMindmapBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new mindmap.resource.mindmap.mopp.MindmapMarkerHelper().getMarkerID(mindmap.resource.mindmap.MindmapEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		mindmap.resource.mindmap.mopp.MindmapTaskItemBuilder taskItemBuilder = new mindmap.resource.mindmap.mopp.MindmapTaskItemBuilder();
		new mindmap.resource.mindmap.mopp.MindmapMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getSyntaxName())) {
