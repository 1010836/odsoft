 ...
 * delegates.
 */
public class MindmapLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends mindmap.resource.mindmap.util.AbstractMindmapInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, mindmap.resource.mindmap.util.AbstractMindmapInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final mindmap.resource.mindmap.debug.MindmapDebuggableInterpreter<ResultType, ContextType> interpreter = new mindmap.resource.mindmap.debug.MindmapDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		mindmap.resource.mindmap.debug.MindmapDebuggerListener<ResultType, ContextType> debugListener = new mindmap.resource.mindmap.debug.MindmapDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		mindmap.resource.mindmap.debug.MindmapDebugProcess process = new mindmap.resource.mindmap.debug.MindmapDebugProcess(launch);
		launch.addDebugTarget(new mindmap.resource.mindmap.debug.MindmapDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(mindmap.resource.mindmap.launch.MindmapLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return mindmap.resource.mindmap.util.MindmapResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, mindmap.resource.mindmap.mopp.MindmapPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
