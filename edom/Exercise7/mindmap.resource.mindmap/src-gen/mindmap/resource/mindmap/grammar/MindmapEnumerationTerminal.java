 ...
 */
public class MindmapEnumerationTerminal extends mindmap.resource.mindmap.grammar.MindmapTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public MindmapEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, mindmap.resource.mindmap.grammar.MindmapCardinality cardinality, int mandatoryOccurrencesAfter) {
