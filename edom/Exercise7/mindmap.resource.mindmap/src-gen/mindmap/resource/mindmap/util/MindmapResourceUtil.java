 ...
 */
public class MindmapResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new mindmap.resource.mindmap.util.MindmapInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new mindmap.resource.mindmap.util.MindmapInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static mindmap.resource.mindmap.mopp.MindmapResource getResource(java.io.File file) {
	...
	public static mindmap.resource.mindmap.mopp.MindmapResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new mindmap.resource.mindmap.mopp.MindmapMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (mindmap.resource.mindmap.mopp.MindmapResource) resource;
	}
	 ...
	 */
	public static mindmap.Map getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static mindmap.Map getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (mindmap.Map) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static mindmap.Map getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		mindmap.resource.mindmap.IMindmapTextResource resource = (mindmap.resource.mindmap.IMindmapTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (mindmap.resource.mindmap.IMindmapTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		mindmap.resource.mindmap.IMindmapTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
