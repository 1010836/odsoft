 ...
 */
public class MindmapStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, mindmap.resource.mindmap.IMindmapFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, mindmap.resource.mindmap.IMindmapFunction1<String, T> toStringFunction) {
