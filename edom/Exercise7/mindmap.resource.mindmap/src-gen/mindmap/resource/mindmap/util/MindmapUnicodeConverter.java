 ...
 * to 4 bytes).
 */
public class MindmapUnicodeConverter extends mindmap.resource.mindmap.mopp.MindmapInputStreamProcessor {
	 ...
	 */
	public MindmapUnicodeConverter(java.io.InputStream inputStream) {
