 ...
 */
public class MindmapDefaultTokenResolver implements mindmap.resource.mindmap.IMindmapTokenResolver {
	 ...
	 */
	public MindmapDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public MindmapDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, mindmap.resource.mindmap.IMindmapTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : mindmap.resource.mindmap.grammar.MindmapGrammarInformationProvider.INSTANCE.getKeywords()) {
