 ...
 */
public interface IMindmapOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getResourcePostProcessorProviderOptionKey();
