...
public class MindmapPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof mindmap.resource.mindmap.ui.MindmapEObjectSelection) {
			final mindmap.resource.mindmap.ui.MindmapEObjectSelection selection = (mindmap.resource.mindmap.ui.MindmapEObjectSelection) iSelection;
