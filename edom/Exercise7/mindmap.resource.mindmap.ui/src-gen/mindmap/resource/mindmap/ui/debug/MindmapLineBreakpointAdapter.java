...
public class MindmapLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(mindmap.resource.mindmap.mopp.MindmapPlugin.DEBUG_MODEL_ID);
			...
			mindmap.resource.mindmap.debug.MindmapLineBreakpoint lineBreakpoint = new mindmap.resource.mindmap.debug.MindmapLineBreakpoint(resource, lineNumber + 1);
