 ...
 * 
 */
package mindmap.resource.mindmap.ui.debug;

@SuppressWarnings("restriction")
public class MindmapAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getSyntaxName())) {
					return new mindmap.resource.mindmap.ui.debug.MindmapLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof mindmap.resource.mindmap.debug.MindmapDebugVariable) {
			final mindmap.resource.mindmap.debug.MindmapDebugVariable variable = (mindmap.resource.mindmap.debug.MindmapDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof mindmap.resource.mindmap.debug.MindmapDebugVariable) {
			final mindmap.resource.mindmap.debug.MindmapDebugVariable variable = (mindmap.resource.mindmap.debug.MindmapDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							mindmap.resource.mindmap.debug.MindmapDebugValue castedValue = (mindmap.resource.mindmap.debug.MindmapDebugValue) value;
