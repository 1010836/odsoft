 ...
 */
public class MindmapSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private mindmap.resource.mindmap.ui.IMindmapBracketHandlerProvider bracketHandlerProvider;
	private mindmap.resource.mindmap.ui.MindmapQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public MindmapSourceViewerConfiguration(mindmap.resource.mindmap.IMindmapResourceProvider resourceProvider, mindmap.resource.mindmap.ui.IMindmapAnnotationModelProvider annotationModelProvider, mindmap.resource.mindmap.ui.IMindmapBracketHandlerProvider bracketHandlerProvider, mindmap.resource.mindmap.ui.MindmapColorManager colorManager) {
		super(mindmap.resource.mindmap.ui.MindmapUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new mindmap.resource.mindmap.ui.MindmapCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new mindmap.resource.mindmap.ui.MindmapTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new mindmap.resource.mindmap.ui.MindmapTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new mindmap.resource.mindmap.ui.MindmapHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new mindmap.resource.mindmap.ui.MindmapQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new mindmap.resource.mindmap.ui.MindmapIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
