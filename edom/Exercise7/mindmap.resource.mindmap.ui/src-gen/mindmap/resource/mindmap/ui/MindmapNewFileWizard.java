...
public class MindmapNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private mindmap.resource.mindmap.ui.MindmapNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public MindmapNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new mindmap.resource.mindmap.ui.MindmapNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			mindmap.resource.mindmap.ui.MindmapUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			mindmap.resource.mindmap.ui.MindmapUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getSyntaxName();
	}
