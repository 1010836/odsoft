...
public class MindmapDebugModelPresentation implements org.eclipse.debug.ui.IDebugModelPresentation {
	
	public MindmapDebugModelPresentation() {
		super();
	}
	...
	public String getEditorId(org.eclipse.ui.IEditorInput input, Object element) {
		if (element instanceof org.eclipse.core.resources.IFile || element instanceof org.eclipse.debug.core.model.ILineBreakpoint) {
			return mindmap.resource.mindmap.ui.MindmapUIPlugin.EDITOR_ID;
		}
		return null;
	}
