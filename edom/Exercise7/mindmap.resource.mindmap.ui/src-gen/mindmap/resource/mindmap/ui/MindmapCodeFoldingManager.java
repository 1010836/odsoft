 ...
 */
public class MindmapCodeFoldingManager {
	
	private class FoldingUpdateListener implements mindmap.resource.mindmap.IMindmapBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(mindmap.resource.mindmap.ui.MindmapEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof mindmap.resource.mindmap.ui.MindmapEditor) {
				mindmap.resource.mindmap.ui.MindmapEditor editor = (mindmap.resource.mindmap.ui.MindmapEditor) workbenchPart;
	...
	protected mindmap.resource.mindmap.ui.MindmapEditor editor;
	 ...
	 */
	public MindmapCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,mindmap.resource.mindmap.ui.MindmapEditor textEditor) {
	...
	private void addCloseListener(final mindmap.resource.mindmap.ui.MindmapEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			mindmap.resource.mindmap.ui.MindmapUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		mindmap.resource.mindmap.IMindmapTextResource textResource = (mindmap.resource.mindmap.IMindmapTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
