 ...
 * olInput</code>.
 */
public class MindmapDocBrowserInformationControlInput {
	
	private final MindmapDocBrowserInformationControlInput fPrevious;
	private MindmapDocBrowserInformationControlInput fNext;
	 ...
	 */
	public MindmapDocBrowserInformationControlInput(MindmapDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public MindmapDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public MindmapDocBrowserInformationControlInput getNext() {
		return fNext;
	}
