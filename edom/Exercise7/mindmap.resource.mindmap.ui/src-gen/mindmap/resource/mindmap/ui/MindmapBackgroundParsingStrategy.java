 ...
 */
public class MindmapBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final mindmap.resource.mindmap.IMindmapTextResource resource, final mindmap.resource.mindmap.ui.MindmapEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final mindmap.resource.mindmap.IMindmapTextResource resource, final mindmap.resource.mindmap.ui.MindmapEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final mindmap.resource.mindmap.IMindmapTextResource resource, final mindmap.resource.mindmap.ui.MindmapEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof mindmap.resource.mindmap.mopp.MindmapResource) {
							mindmap.resource.mindmap.mopp.MindmapResource concreteResource = (mindmap.resource.mindmap.mopp.MindmapResource) resource;
