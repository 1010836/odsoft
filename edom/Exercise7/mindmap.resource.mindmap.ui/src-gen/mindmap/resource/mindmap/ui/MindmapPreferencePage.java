 ...
 */
public class MindmapPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(mindmap.resource.mindmap.ui.MindmapUIPlugin.getDefault().getPreferenceStore());
		setDescription("Mindmap Text Editor Preferences");
	}
