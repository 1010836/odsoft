 ...
 */
public class MindmapCompletionProposal implements java.lang.Comparable<MindmapCompletionProposal> {
	 ...
	 */
	private mindmap.resource.mindmap.mopp.MindmapExpectedTerminal expectedTerminal;
	...
	public MindmapCompletionProposal(mindmap.resource.mindmap.mopp.MindmapExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public MindmapCompletionProposal(mindmap.resource.mindmap.mopp.MindmapExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public MindmapCompletionProposal(mindmap.resource.mindmap.mopp.MindmapExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public mindmap.resource.mindmap.mopp.MindmapExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof MindmapCompletionProposal) {
			MindmapCompletionProposal other = (MindmapCompletionProposal) object;
	...
	public int compareTo(MindmapCompletionProposal object) {
		if (object instanceof MindmapCompletionProposal) {
			MindmapCompletionProposal other = (MindmapCompletionProposal) object;
