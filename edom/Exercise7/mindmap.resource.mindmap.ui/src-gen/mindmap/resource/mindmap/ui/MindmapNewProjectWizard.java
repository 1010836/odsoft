 ...
 */
public class MindmapNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public MindmapNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("mindmap.resource.mindmap.ui");
							...
							String natureID = mindmap.resource.mindmap.mopp.MindmapNature.NATURE_ID;
							...
							for (String builderID : mindmap.resource.mindmap.mopp.MindmapNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								mindmap.resource.mindmap.mopp.MindmapMetaInformation info = new mindmap.resource.mindmap.mopp.MindmapMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = mindmap.resource.mindmap.ui.MindmapUIPlugin.getDefault().getBundle();
