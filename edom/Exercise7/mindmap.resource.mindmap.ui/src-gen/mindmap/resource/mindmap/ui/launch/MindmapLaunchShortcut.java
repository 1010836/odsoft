 ...
 */
public class MindmapLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(mindmap.resource.mindmap.launch.MindmapLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			mindmap.resource.mindmap.mopp.MindmapPlugin.logError("Exception while launching selection", e);
		}
	}
