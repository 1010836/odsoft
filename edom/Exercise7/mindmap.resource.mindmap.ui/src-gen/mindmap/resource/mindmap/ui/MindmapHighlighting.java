 ...
 */
public class MindmapHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static mindmap.resource.mindmap.ui.MindmapPositionHelper positionHelper = new mindmap.resource.mindmap.ui.MindmapPositionHelper();
	...
	private mindmap.resource.mindmap.ui.MindmapTokenScanner scanner;
	...
	private mindmap.resource.mindmap.ui.MindmapEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private mindmap.resource.mindmap.ui.MindmapOccurrence occurrence;
	private mindmap.resource.mindmap.ui.MindmapBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, mindmap.resource.mindmap.IMindmapBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public MindmapHighlighting(mindmap.resource.mindmap.IMindmapTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, mindmap.resource.mindmap.ui.MindmapColorManager colorManager, mindmap.resource.mindmap.ui.MindmapEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = mindmap.resource.mindmap.ui.MindmapUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new mindmap.resource.mindmap.ui.MindmapTokenScanner(textResource, colorManager);
		occurrence = new mindmap.resource.mindmap.ui.MindmapOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new mindmap.resource.mindmap.ui.MindmapBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(mindmap.resource.mindmap.ui.MindmapPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, mindmap.resource.mindmap.ui.MindmapPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(mindmap.resource.mindmap.ui.MindmapEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, mindmap.resource.mindmap.ui.MindmapPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, mindmap.resource.mindmap.ui.MindmapPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(mindmap.resource.mindmap.ui.MindmapPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new mindmap.resource.mindmap.ui.MindmapEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
