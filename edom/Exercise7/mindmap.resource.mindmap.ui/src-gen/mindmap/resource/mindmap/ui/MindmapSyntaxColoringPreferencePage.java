 ...
 */
public class MindmapSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public MindmapSyntaxColoringPreferencePage() {
		super();
		
		mindmap.resource.mindmap.mopp.MindmapMetaInformation metaInformation = new mindmap.resource.mindmap.mopp.MindmapMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mindmap.resource.mindmap.ui.MindmapSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		mindmap.resource.mindmap.ui.MindmapPixelConverter pixelConverter = new mindmap.resource.mindmap.ui.MindmapPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof mindmap.resource.mindmap.ui.MindmapEditor) {
			mindmap.resource.mindmap.ui.MindmapEditor emfTextEditor = (mindmap.resource.mindmap.ui.MindmapEditor) editor;
