 ...
 */
public class MindmapUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "mindmap.resource.mindmap.ui";
	public static final String EDITOR_ID = "mindmap.resource.mindmap.ui.MindmapEditor";
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MindmapUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MindmapUIPlugin.PLUGIN_ID, message);
		}
		final MindmapUIPlugin pluginInstance = MindmapUIPlugin.getDefault();
