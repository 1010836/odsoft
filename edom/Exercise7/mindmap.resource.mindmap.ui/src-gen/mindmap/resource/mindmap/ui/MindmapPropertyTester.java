...
public class MindmapPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getSyntaxName());
	}
