...
public class MindmapMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(mindmap.resource.mindmap.IMindmapOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof mindmap.resource.mindmap.mopp.MindmapResource) {
					mindmap.resource.mindmap.mopp.MindmapResource customResource = (mindmap.resource.mindmap.mopp.MindmapResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<mindmap.resource.mindmap.IMindmapQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final mindmap.resource.mindmap.IMindmapQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									mindmap.resource.mindmap.ui.MindmapUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			mindmap.resource.mindmap.ui.MindmapUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<mindmap.resource.mindmap.IMindmapQuickFix> getQuickFixes(mindmap.resource.mindmap.IMindmapTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					mindmap.resource.mindmap.IMindmapQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
