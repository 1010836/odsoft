 ...
 * @since 3.2
 */
public class MindmapBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private mindmap.resource.mindmap.ui.MindmapDocBrowserInformationControlInput fInput;
	 ...
	 */
	public MindmapBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public MindmapBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public MindmapBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof mindmap.resource.mindmap.ui.MindmapDocBrowserInformationControlInput);
		...
		fInput= (mindmap.resource.mindmap.ui.MindmapDocBrowserInformationControlInput) input;
		...
		mindmap.resource.mindmap.ui.MindmapHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = mindmap.resource.mindmap.ui.MindmapHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public mindmap.resource.mindmap.ui.MindmapDocBrowserInformationControlInput getInput() {
		return fInput;
	}
