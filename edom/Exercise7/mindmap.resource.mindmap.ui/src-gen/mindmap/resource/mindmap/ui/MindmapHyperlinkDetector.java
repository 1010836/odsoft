 ...
 * hovers, is a proxy.
 */
public class MindmapHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public MindmapHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (mindmap.resource.mindmap.IMindmapTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new mindmap.resource.mindmap.ui.MindmapHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
