 ...
 */
public class MindmapNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public MindmapNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new mindmap file");
