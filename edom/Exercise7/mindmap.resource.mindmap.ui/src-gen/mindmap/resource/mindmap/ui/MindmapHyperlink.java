 ...
 */
public class MindmapHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public MindmapHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				mindmap.resource.mindmap.mopp.MindmapPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
