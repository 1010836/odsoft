 ...
 * a specified depth.
 */
public class MindmapOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public MindmapOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = mindmap.resource.mindmap.util.MindmapStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof mindmap.resource.mindmap.ui.MindmapEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			mindmap.resource.mindmap.mopp.MindmapPlugin.logError("Exception while refreshing outline view", e);
		}
	}
