 ...
 */
public class MindmapBracketSet {
	...
	private java.util.ArrayList<mindmap.resource.mindmap.IMindmapBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements mindmap.resource.mindmap.IMindmapBracketPair {
	 ...
	 */
	private class ClosingListener implements mindmap.resource.mindmap.ui.IMindmapBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				mindmap.resource.mindmap.IMindmapBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public MindmapBracketSet(mindmap.resource.mindmap.ui.MindmapEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new mindmap.resource.mindmap.mopp.MindmapMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<mindmap.resource.mindmap.IMindmapBracketPair>();
	 ...
	 */
	public mindmap.resource.mindmap.IMindmapBracketPair getBracketPair(String opening, String closing) {
		for (mindmap.resource.mindmap.IMindmapBracketPair bracketPair : bracketPairs) {
	...
	public mindmap.resource.mindmap.IMindmapBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(mindmap.resource.mindmap.IMindmapBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + mindmap.resource.mindmap.ui.MindmapPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public mindmap.resource.mindmap.IMindmapBracketPair remove(String opening, String closing) {
		for (mindmap.resource.mindmap.IMindmapBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<mindmap.resource.mindmap.IMindmapBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, mindmap.resource.mindmap.ui.MindmapPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, mindmap.resource.mindmap.ui.MindmapPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
