...
public interface MindmapPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int TOPIC__PRIORITY = MAP_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int TOPIC__SUBTOPICS = MAP_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int TOPIC__PARENT = MAP_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TOPIC_FEATURE_COUNT = MAP_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int RELATIONSHIP_FEATURE_COUNT = MAP_ELEMENT_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the '{@link mindmap.Topic#allSubTopics() <em>All Sub Topics</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
