...
public class Main 
{
	...
	public static String testCreateProduct() {
    	...
    	headerMap.put("login.username", Arrays.asList(new Object [] { "admin" }));
       	...
       	JsonObject value = Json.createObjectBuilder()
       	     ...
       	     .add("comments", "You like this product, don't you?")
       	     .build();
	...
	public static void testUpdateProduct(String productId, String newInternalName, String newProductName,
			String newDescription, String newProductComment) {
        Client client = ClientBuilder.newClient();
    	...
    	headerMap.put("login.username", Arrays.asList(new Object [] { "admin" }));
       	...
       	JsonObject value = Json.createObjectBuilder()
       	     ...
       	     .add("comments", newProductComment)
       	     .build();
	...
	public static void main(String[] args) 
	{
	  ...
	  String productId=null;
		...
		testGetProductByName("Gift Card Activation"); // devolve uma lista, porque o productName n�o � �nico
		System.out.println("");
